...
<jstl:if test="${isPrincipalAuthorizedEdit}">
	<form:form action="brotherhood/brotherhood-none/edit.do" method="post"
		id="formEdit" name="formEdit" modelAttribute="brotherhoodForm">
		...
		<div>
			<fieldset>
				...
				<jstl:forEach items="${brotherhoodForm.pictures}" var="iter"
					varStatus="iterStatus">
					<acme:textbox path="pictures[${iterStatus.index}].url"
						code="brotherhood.picture" />
					<br>
				</jstl:forEach>
		...
		<a href="law/terminosYCondiciones.do"><spring:message
				code="brotherhood.consultTermsAndConditions" /></a>
		<br />
