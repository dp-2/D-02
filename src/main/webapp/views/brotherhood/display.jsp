...
<img src="<jstl:out value='${brotherhood.photo}' />"
	alt="<jstl:out value='${brotherhood.photo}' />" />
...
<p>
	<spring:message code="brotherhood.spammer" />
	:
	<jstl:out value="${brotherhood.spammer}" />
</p>
<p>
	<spring:message code="brotherhood.banned" />
	:
	<jstl:out value="${brotherhood.banned}" />
</p>
<p>
	<spring:message code="brotherhood.score" />
	:
...
<fmt:formatDate pattern='yyyy-MM-dd'
	value='${brotherhood.establishedMoment}' var="establishedMoment" />
<p>
	<spring:message code="brotherhood.establishedMoment" />
	:
	<jstl:out value="${establishedMoment}" />
</p>
...
<fieldset>
	...
	<jstl:forEach items="${brotherhoodPictures}" var="picture">
		<img src="<jstl:out value='${picture.url}' />"
			alt="<jstl:out value='${picture.url}' />" />
	</jstl:forEach>
</fieldset>
